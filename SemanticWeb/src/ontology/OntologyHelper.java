...
//	public final String nameSpace = "http://protege.stanford.edu/ontologies/pizza/pizza.owl#";
	...
	public void initOntologyModel(){
		...
		try{
			model.read(uri,null);}catch (Exception e){
 ...
 */
	public void printOntology(int i){
		switch (i){
			case 0: model.write(System.out,"RDF/XML-ABBREV"); break;
			case 1: model.write(System.out,"N-Triples"); break;
			case 2: model.write(System.out,"TriG"); break;
			case 3: model.write(System.out,"N-Quads"); break;
			case 4: model.write(System.out,"TURTLE"); break;
			case 5: model.write(System.out,"RDF/JSON"); break;
		}
	}
	 ...
	 * Classes are unique in OntModel and will be overwritten if used more than once.
