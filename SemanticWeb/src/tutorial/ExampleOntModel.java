...
//		Model model = OracleModelNoSql.createOracleModelNoSql(graphNode, conn);
//
//		// Clear model
//		model.removeAll();
//
...
//		graph.add(triple);
//
//		graph.add(Triple.create(pred, Node.createURI("http://www.w3.org/2000/01/rdf-schema#domain"), Node.createURI("http://C")));
//
//		graph.add(Triple.create(pred, Node.createURI("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"), Node.createURI("http://www.w3.org/2002/07/owl#ObjectProperty")));
//
//		{
//			// read it out
